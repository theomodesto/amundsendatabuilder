...
from amundsen_rds.models.dashboard import DashboardSteward as RDSDashboardSteward

from databuilder.models.dashboard.dashboard_metadata import DashboardMetadata
from databuilder.models.graph_node import GraphNode
from databuilder.models.graph_relationship import GraphRelationship
from databuilder.models.graph_serializable import GraphSerializable
from databuilder.models.steward_constants import STEWARD_OF_OBJECT_RELATION_TYPE, STEWARD_RELATION_TYPE
...
class DashboardSteward(GraphSerializable, TableSerializable):
    """
    A model that encapsulate Dashboard's steward.
    ...
    def _create_relation_iterator(self) -> Iterator[GraphRelationship]:
        relationship = GraphRelationship(
            ...
            type=STEWARD_RELATION_TYPE,
            reverse_type=STEWARD_OF_OBJECT_RELATION_TYPE,
            attributes={}
        )
        yield relationship
    ...
    def __repr__(self) -> str:
        return f'DashboardSteward({self._dashboard_group_id!r}, {self._dashboard_id!r}, ' \
